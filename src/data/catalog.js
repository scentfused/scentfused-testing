export const CATEGORIES = [
  {
    key: 'perfumes',
    label: 'Perfumes',
    blurb: 'Alcohol-based eau de parfum, layered for depth and built to last through the day.'
  },
  {
    key: 'attars',
    label: 'Non-alcoholic perfumes',
    blurb: 'Oil-based attars, gentle on skin and true to their scent from morning into night.'
  },
  {
    key: 'soaps',
    label: 'Soaps & bodywash',
    blurb: 'Everyday washes finished with the same notes as the perfumes above.'
  },
  {
    key: 'candles',
    label: 'Scented candles',
    blurb: "Hand-poured candles that carry the collection's signature accords into a room."
  }
]
...
export const initialProducts = Object.entries(raw).flatMap(
  ([category, items]) =>
    items.map((item) => ({
      id: counter++,
      category,
